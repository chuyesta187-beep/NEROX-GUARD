...
app.get('/dashboard', isAuth, (req, res) => {
    ...
    <html lang="es">
    <head>
        <meta charset="UTF-8"><title>Dashboard - NEROX GUARD</title>
        <style>
            body { background: #020617; color: #fff; font-family: system-ui, sans-serif; padding: 40px; }
            .header { display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #1e293b; padding-bottom: 20px; }
            a.btn { background: #ef4444; color: #fff; padding: 8px 16px; border-radius: 6px; text-decoration: none; font-size: 0.85em; }
        </style>
    </head>
    <body>
        <div class="header">
        ...
        <p style="margin-top:20px; color:#94a3b8;">Selecciona un servidor habilitado desde las rutas de API para comenzar a configurar.</p>
    </body>
    </html>
    `);
});
