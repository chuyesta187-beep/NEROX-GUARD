// ==========================================
// NEROX GUARD - INDEX ENTERPRISE v3.0 (FIXED SYNTAX & CYBER CANVAS)
// ==========================================
...
// 3. CONFIGURACIÓN DE EXPRESS & MIDDLEWARES
const app = express();
...
// 4. LAYOUT SAAS DE NAVEGACIÓN DEDICADA
        ...
        <style>
            ...
            * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Segoe UI', system-ui, sans-serif; }
            ...
            .glass-card {
                ...
                animation: introCard 1s cubic-bezier(0.16, 1, 0.3, 1) 0.5s forwards;
            }
            ...
            .support-link-btn { display: inline-flex; align-items: center; gap: 6px; color: var(--cyan-glow); font-size: 0.85em; text-decoration: none; margin-top: 6px; font-weight: 600; }
                ...
                <form action="/api/verify-captcha" method="POST">
                    ...
                    <div class="checkbox-container">
                        ...
                        <label for="joinSupport">
                            ...
                            <br>
                            <a href="${SUPPORT_INVITE_URL}" target="_blank" class="support-link-btn">
