...
const client = new Client({
    intents: [
        ...
        GatewayIntentBits.GuildBans,         // Corregido para Discord.js v14
...
// ANTI-RAID: Detección de Joins Masivos
...
client.on('channelDelete', async (channel) => {
    ...
    try {
        ...
        // Revocar permisos / Banear agresor
